                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Cast</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                    ...
                    <div class="col-xl-12 col-xxl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Edit Cast Form</h4>
                            ...
                            <div class="card-body">
                                <form action="{{route('admin.castUpdate')}}" method="post" id="step-form-horizontal" class="step-form-horizontal">
                                   @csrf
                                   <input type="hidden" name="id" value="{{$editCastView->id}}">
                                    <div>
                                        <!-- <h4>Personal Info</h4> -->
                                        <section>
                                            <div class="row">
                                                <div class="col-lg-6 mb-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="cast_name" value="{{$editCastView->cast_name}}" class="form-control" placeholder="Cast" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </section>
