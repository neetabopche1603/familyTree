        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a href="{{route('admin.showAllCast')}}" class="ai-icon" aria-expanded="false">
							<i class="flaticon-381-settings-2"></i>
							<span class="nav-text">Cast</span>
						</a>
					</li>

                    <li><a href="{{route('admin.showMember')}}" class="ai-icon" aria-expanded="false">
                        <i class="flaticon-381-settings-2"></i>
				...
				<div class="copyright">
					<p><strong>EMS</strong> © 2022 All Rights Reserved</p>
					<p>Made with <i class="fa fa-heart"></i> by Ayush Sisodiya</p>
				</div>
			</div>
        </div>
        <!--**********************************
